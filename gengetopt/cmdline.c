/*
  ...
  gengetopt --unnamed-opts --include-getopt
...
const char *gengetopt_args_info_purpose = "Lab1 2024 osisp";

const char *gengetopt_args_info_usage = "Usage: dirwalk [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -l, --links    символические ссылки  (default=off)",
  "  -d, --dirs     каталоги  (default=off)",
  "  -f, --files    файлы  (default=off)",
  "  -s, --sort     сортировать выход в соответствии с LC_COLLATE  (default=off)",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->links_given = 0 ;
  args_info->dirs_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->links_flag = 0;
  args_info->dirs_flag = 0;
  args_info->files_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->links_help = gengetopt_args_info_help[2] ;
  args_info->dirs_help = gengetopt_args_info_help[3] ;
  args_info->files_help = gengetopt_args_info_help[4] ;
  args_info->sort_help = gengetopt_args_info_help[5] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->links_given)
    write_into_file(outfile, "links", 0, 0 );
  if (args_info->dirs_given)
    write_into_file(outfile, "dirs", 0, 0 );
  if (args_info->files_given)
    write_into_file(outfile, "files", 0, 0 );
  if (args_info->sort_given)
    write_into_file(outfile, "sort", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVldfs", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'l':	/* символические ссылки.  */
        
        
          if (update_arg((void *)&(args_info->links_flag), 0, &(args_info->links_given),
              &(local_args_info.links_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "links", 'l',
              additional_error))
            goto failure;
        ...
        case 'd':	/* каталоги.  */
          ...
          if (update_arg((void *)&(args_info->dirs_flag), 0, &(args_info->dirs_given),
              &(local_args_info.dirs_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "dirs", 'd',
              additional_error))
            goto failure;
        ...
        case 'f':	/* файлы.  */
          ...
          if (update_arg((void *)&(args_info->files_flag), 0, &(args_info->files_given),
              &(local_args_info.files_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "files", 'f',
              additional_error))
            goto failure;
        
          break;
        case 's':	/* сортировать выход в соответствии с LC_COLLATE.  */
        
        
          if (update_arg((void *)&(args_info->sort_flag), 0, &(args_info->sort_given),
              &(local_args_info.sort_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "sort", 's',
              additional_error))
            goto failure;
